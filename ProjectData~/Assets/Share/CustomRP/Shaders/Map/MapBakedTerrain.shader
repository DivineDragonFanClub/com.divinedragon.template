Shader "CustomRP/Map/MapBakedTerrain" {
    ...
    SubShader
    {
        ...
        float4 frag(Varyings i) : SV_TARGET
        {
            ...
            #if defined(_S_KEY_DETAIL_ALBEDO)
                float3 detailAlbedo = SAMPLE_TEXTURE2D(_DetailAlbedoMap, sampler_DetailAlbedoMap,
                    i.uv * _DetailAlbedoMap_ST.xy + _DetailAlbedoMap_ST.zw).rgb;
                albedo *= detailAlbedo * 2.0;
            #endif
            ...
            #endif
            float3 finalColor = rim + albedo * lighting;
        ...
        Pass
        {
            ...
            #pragma shader_feature _ _S_KEY_DETAIL_ALBEDO
