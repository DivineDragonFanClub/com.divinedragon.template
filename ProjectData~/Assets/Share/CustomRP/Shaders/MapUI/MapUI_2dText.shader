Shader "CustomRP/MapUI/MapUI_2dText" {
	Properties {
		...
		_UnderlayOffsetX ("Border OffsetX", Range(-100, 100)) = 0
		_UnderlayOffsetY ("Border OffsetY", Range(-100, 100)) = 0
		_UnderlayDilate ("Border Dilate", Range(-100, 100)) = 0
		_UnderlaySoftness ("Border Softness", Range(0, 100)) = 0
		...
		_MultiSampleScale ("Multi Sample Scale", Range(0, 16)) = 1
		_MultiSampleAlpha ("Multi Sample Alpha", Range(0, 2)) = 1
	}
	...
	//CustomEditor "UnityEditor.CustomRP.UI_TextShaderGUI"
}